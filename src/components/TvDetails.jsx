...
const TvDetails = () => {
  document.title = "CineLibrary| TV Details";
  ...
  const availableGenres = useMemo(() => {
    const set = new Set();
    sourceData.forEach((tv) =>
      tv.genre_ids?.forEach((g) => GENRES[g] && set.add(g))
    );
  ...
  return (
    ...
    >
      ...
      <section className="mt-20">
        ...
        <HorizontalCards title="tv" data={filteredShows} />
      </section>
